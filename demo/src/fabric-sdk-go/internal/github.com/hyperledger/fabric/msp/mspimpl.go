...
import (
	...
	"github.com/hyperledger/fabric-sdk-go/internal/github.com/hyperledger/fabric/plugins/huawei/hbccsp/hx509"
...
func (msp *bccspmsp) getCertFromPem(idBytes []byte) (*x509.Certificate, error) {
	...
	cert, err := hx509.ParseCertificate(pemCert.Bytes)
	if err != nil {
...
func (msp *bccspmsp) deserializeIdentityInternal(serializedIdentity []byte) (Identity, error) {
	...
	cert, err := hx509.ParseCertificate(bl.Bytes)
	if err != nil {
...
func (msp *bccspmsp) getUniqueValidationChain(cert *x509.Certificate, opts x509.VerifyOptions) ([]*x509.Certificate, error) {
	...
	validationChains, err := hx509.Verify(cert, opts)
	if err != nil {
