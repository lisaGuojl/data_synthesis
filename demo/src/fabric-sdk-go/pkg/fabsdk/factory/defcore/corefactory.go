...
import (
	...
	cryptosuiteimplSm "github.com/hyperledger/fabric-sdk-go/pkg/core/cryptosuite/bccsp/sm"
...
func (f *ProviderFactory) CreateCryptoSuiteProvider(config core.CryptoSuiteConfig) (core.CryptoSuite, error) {
	...
	case "sm":
		cryptoSuiteProvider, err = cryptosuiteimplSm.GetSuiteByConfig(config)
	default:
		return nil, errors.New("Unsupported BCCSP Provider")
	}
